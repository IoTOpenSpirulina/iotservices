...
clear
msg="
     _______..______    __  .______       __    __   __       __  .__   __.      ___      
    /       ||   _  \  |  | |   _  \     |  |  |  | |  |     |  | |  \ |  |     /   \     
   |   (----\`|  |_)  | |  | |  |_)  |    |  |  |  | |  |     |  | |   \|  |    /  ^  \    
    \   \    |   ___/  |  | |      /     |  |  |  | |  |     |  | |  . \`  |   /  /_\  \   
.----)   |   |  |      |  | |  |\  \----.|  \`--'  | |  \`----.|  | |  |\   |  /  _____  \  
|_______/    | _|      |__| | _| \`._____| \______/  |_______||__| |__| \__| /__/     \__\ 
...
msg="
.______       _______      _______. __    __  .___  ___.  _______ .__   __. 
|   _  \     |   ____|    /       ||  |  |  | |   \/   | |   ____||  \ |  | 
|  |_)  |    |  |__      |   (----\`|  |  |  | |  \  /  | |  |__   |   \|  | 
|      /     |   __|      \   \    |  |  |  | |  |\/|  | |   __|  |  . \`  | 
|  |\  \----.|  |____ .----)   |   |  \`--'  | |  |  |  | |  |____ |  |\   | 
...
sudo git clone https://github.com/IoTOpenSpirulina/iotservices.git
sudo mv iotservices services
...
sudo git clone https://github.com/IoTOpenSpirulina/iotapp.git
sudo mv iotapp  app
